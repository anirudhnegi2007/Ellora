      ...
      <section className="relative overflow-hidden bg-zinc-900 text-white py-24 sm:py-32">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col items-start gap-6 max-w-2xl">
          ...
          <p className="text-lg text-zinc-300">
            Discover a curated collection of handcrafted bags, high-performance electronics, and premium lifestyle accessories.
          </p>
          <div className="flex gap-4 mt-2">
            ...
            <span className="rounded-full border border-zinc-500 px-6 py-3 text-sm font-semibold text-zinc-300 hover:bg-white/10 hover:text-white transition-all cursor-pointer">
              Learn More
            </span>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pt-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
          {categories.map((category) => (
            <div
              key={category}
              className="group relative flex h-24 items-center justify-center overflow-hidden rounded-xl border border-zinc-200 bg-white p-4 shadow-sm transition-all hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900 cursor-pointer"
            >
